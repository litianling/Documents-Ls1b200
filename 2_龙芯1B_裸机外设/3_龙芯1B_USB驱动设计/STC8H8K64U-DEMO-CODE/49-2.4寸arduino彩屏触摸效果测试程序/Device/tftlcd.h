...
//IO连接
#define TFT_LCD_DATAPORTH 			P0     //高8位数据口,8位模式下只使用高8位 
#define TFT_LCD_DATAPORTH_IN	 	{ P0M1=0xff;P0M0=0x00;}		//P6口高阻输入
#define TFT_LCD_DATAPORTH_OUT	 	{ P0M1=0x00;P0M0=0xff;}		//P6口推挽输出

#define TFT_LCD_DATAPORTL 			P2     //低8位数据口,8位模式下只使用高8位


#define TFT_LCD_RESET 				P43//15
#define TFT_LCD_RESET_OUT			{P4M1&=~0x08;P4M0|=0x08;}	//推挽输出

#define TFT_LCD_CS 						P17//13
#define TFT_LCD_CS_OUT			  {P1M1&=~0x80;P1M0|=0x80;}	//推挽输出

#define TFT_LCD_RS 						P16//03
#define TFT_LCD_RS_OUT			  {P1M1&=~0x40;P1M0|=0x40;}	//推挽输出

#define TFT_LCD_WR 						P15//11
#define TFT_LCD_WR_OUT  			{P1M1&=~0x20;P1M0|=0x20;}	//推挽输出

#define TFT_LCD_RD 						P14//10
#define TFT_LCD_RD_OUT   			{P1M1&=~0x10;P1M0|=0x10;}	//推挽输出
