...
{
		P_SW2 |= 0x80;
	  PWMB_CCR1H = (u8)(PWM5_Duty >> 8); //设置占空比时间
    PWMB_CCR1L = (u8)(PWM5_Duty);
	  PWMB_CCR2H = (u8)(PWM6_Duty >> 8); //设置占空比时间
    PWMB_CCR2L = (u8)(PWM6_Duty);
	  PWMB_CCR3H = (u8)(PWM7_Duty >> 8); //设置占空比时间
    PWMB_CCR3L = (u8)(PWM7_Duty);
	  PWMB_CCR4H = (u8)(PWM8_Duty >> 8); //设置占空比时间
    PWMB_CCR4L = (u8)(PWM8_Duty);
		P_SW2 &= 0x7f;
}
