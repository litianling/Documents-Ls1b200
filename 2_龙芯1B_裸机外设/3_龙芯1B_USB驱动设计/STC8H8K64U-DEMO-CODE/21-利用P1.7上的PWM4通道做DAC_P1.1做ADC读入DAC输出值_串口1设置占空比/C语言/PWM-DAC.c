...
void main(void)
{
    ...
    PWMA_CCER2 = 0x50; //使能 CC4E 通道

    PWMA_ARRH = 2; //设置周期时间
    PWMA_ARRL = 0;
    PWMA_CCR4H = 0;
    PWMA_CCR4L = 128; //设置占空比时间
...
//  PWMA_PS = 0x00;  //高级 PWM 通道 4P 输出脚选择位, 0x00:P1.6, 0x40:P2.6, 0x80:P6.6, 0xC0:P3.4
    PWMA_BKR = 0x80; //使能主输出
    PWMA_CR1 |= 0x01; //开始计时
		P_SW2 &= 0x7f;
...
{
		P_SW2 |= 0x80;
	  PWMA_CCR4H = (u8)(pwm_value >> 8); //设置占空比时间
    PWMA_CCR4L = (u8)(pwm_value);
		P_SW2 &= 0x7f;
}
